...
const readPluginsFld = fs.readdirSync(dirToPlugin);
const readGamesFld = fs.readdirSync(dirToGame);
const readlevelFld = fs.readdirSync(dirToLevel);
const readOtherFld = fs.readdirSync(dirToOthers);
