  ...
  return (
    ...
    >
      ...
      <Modal.Body>
        ...
        <Form.Control
          as="textarea"
          placeholder="Unique Alert Message"
          rows={9}
          style={{ resize: "none" }}
        />
      </Modal.Body>
    ...
    <Container>
      <Form.Group>
        <Form.Check
          type="switch"
          id="custom-switch"
          label="Activate Unique Alert"
          style={{ userSelect: "none" }}
        />
      </Form.Group>
      <Form.Group controlId="exampleForm.ControlTextarea1">
        <Form.Label>Edit/Delete Sub Message</Form.Label>
